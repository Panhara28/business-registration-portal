  ...
  return (
    <>
      ...
      <nav
        ...
        className="sticky top-0 z-50 hidden border-b border-white/50 bg-white/70 shadow-[0_1px_2px_rgba(15,23,42,0.06)] backdrop-blur-md backdrop-saturate-150 backdrop-brightness-125 lg:block"
      >
