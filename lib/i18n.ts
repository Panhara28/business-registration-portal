...
const dictionary = {
  km: {
    ...
    prototypeNoticeTitle: 'គំរូបង្ហាញរូបរាង',
    prototypeNoticeBody:
      'នេះជាគំរូបង្ហាញរូបរាងតែប៉ុណ្ណោះ មិនមែនប្រព័ន្ធផ្លូវការទេ។ ព័ត៌មានក្នុងតង្កៀប [] រង់ចាំការបញ្ចូលជាផ្លូវការ។',
    ...
    search: 'ស្វែងរក',
    heroEyebrow: 'ប្រព័ន្ធចុះបញ្ជីពាណិជ្ជកម្មតាមប្រព័ន្ធអេឡិចត្រូនិក',
    heroTitleLead: 'ចុះបញ្ជីអាជីវកម្មរបស់អ្នក',
    heroTitleAccent: 'តាមប្រព័ន្ធអនឡាញ',
    heroBody:
      'ដាក់ពាក្យ បម្រុងទុកនាមករណ៍ ធ្វើបច្ចុប្បន្នភាព និងទទួលបានវិញ្ញាបនបត្រ តាមចំណុចប្រទាក់តែមួយ។',
    startRegistration: 'ចាប់ផ្តើមចុះបញ្ជី',
    howItWorks: 'របៀបដំណើរការ',
    trustedNote: 'សេវាកម្មរបស់នាយកដ្ឋានចុះបញ្ជីពាណិជ្ជកម្ម ក្រសួងពាណិជ្ជកម្ម',
    quickLinks: 'ទំនាក់ទំនងរហ័ស',
    servicesEyebrow: 'សេវាកម្មអនឡាញ',
    servicesTitleLead: 'សេវាកម្មចុះបញ្ជីពាណិជ្ជកម្ម',
    servicesTitleAccent: 'ពេញលេញតាមអនឡាញ',
  ...
  en: {
    ...
    prototypeNoticeTitle: 'Design prototype',
    prototypeNoticeBody:
      'This is a design prototype, not the official system. Text shown in square brackets [] is awaiting official content.',
    hotline: 'Hotline',
    language: 'Language',
    khmer: 'ខ្មែរ',
    english: 'English',
    ...
    trustedNote:
      'A service of the Business Registration Department, Ministry of Commerce',
